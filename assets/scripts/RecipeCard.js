class RecipeCard extends HTMLElement {
  ...
  set data(data) {
    ...
    title_a.setAttribute('href', getUrl(data));
    title_a.textContent=searchForKey(data, "headline");;
    ...
    if(ratingvalue==undefined){
      const rating_a = document.createElement('span');
      rating_a.textContent="No Reviews";
      rating.appendChild(rating_a);
    }
    else{
      ...
      rating.appendChild(rating_b);
      rating.appendChild(rating_img);
      rating.appendChild(rating_c);
    }
    
    const time = document.createElement('time');
    console.log(searchForKey(data, "totalTime"));
